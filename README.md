...
| [Match Units](./docs/Match%20Units.md) | Design › Inspect | Compare the active document's length and mass units with your Fusion default units and change the document to match in one click. The button's icon reports whether they agree, and an optional prompt asks when a document opens. |
