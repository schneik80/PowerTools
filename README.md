...
| [Infer Constraints](./docs/Infer%20Constraints.md) | Design › Tools › Power Tools | Infer assembly joints/constraints from component geometry. Great for creating joints/constraints on imported assemblies. |
| [Component Warning](./docs/Component%20Warning.md) | File › PowerTools Settings | Toggle warnings about creating features outside a component. |
| [Change Cycle Color](./docs/Change%20Cycle%20Color.md) | Design › Right-click menu | Set the per-component color used by Fusion's Color Cycling Toggle on selected components. Better than selecting fusions random colors. |
...
| [Document References](./docs/Document%20References.md) | Design › Tools › Power Tools | List all documents related to the active design. Shows, parents, drawings, Top level (root) assemblies, fasteners, child components, and any [ Related Data](./docs/Related%20Data.md). |
| [Document Refresh](./docs/Document%20Refresh.md) | Design › Tools › Power Tools | Refresh out-of-date active document to latest version on cloud. Great when working in a team and others have update a document you have open. |
...
| [Default Folders](./docs/Default%20Folders.md) | Design › Tools › Power Tools | Create default project folders in a new project using one of several configured folder schemes. |
| [Favorites](./docs/Favorites.md) | Design › Tools › Power Tools | Manage favorite documents and folders. Also allows quickly navigating to favorites in the data panel. |
...
| [Match Units](./docs/Match%20Units.md) | Design › Inspect | Compare the active document's length and mass units with your Fusion default units and change the document to match in one click. The button's icon reports whether they agree. Optional prompts catch a mismatch when a document opens, and when you switch to the Manufacture workspace, where Fusion keeps a separate unit system that silently changes your feeds and speeds. |
