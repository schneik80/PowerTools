...
def joint_def_lines(names: SchemaNames, joint_types) -> list:
    ...
    lines.append("        // root component's coordinates. Declared here and")
    lines.append("        // redefined per connection; a joint whose geometry")
    lines.append("        // Fusion did not supply leaves these unset rather than")
    lines.append("        // claiming the origin.")
